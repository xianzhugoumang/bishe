		...
		<div class="container-fluid main-content">
			<div class="widget-container fluid-height clearfix mwi1200">
				<div class="heading clearfix">
					<i class="icon-reorder"></i>修改违章记录1<a href="javascript:;"
				...
				<div class="widget-content padded clearfix">
					<form id="create_reord" class="form-horizontal"
						...
						<div class="form-group field-task-subject required">
							...
							<div class="col-sm-8">
								<input type="text" id="policename" class="form-control"
									name="topic" maxlength="40" placeholder="<%=request.getParameter("policename") %>">
							</div>
						</div>
						<div class="form-group field-task-subject required">
							...
							<div class="col-sm-8">
								<input type="text" id="drivername" class="form-control"
									name="topic" maxlength="40" placeholder="<%=request.getParameter("drivername") %>">
							</div>
						</div>
						<div class="form-group field-task-subject required">
							...
							<div class="col-sm-8">
								<input type="text" id="record_no" class="form-control"
									name="topic" maxlength="40" placeholder="<%=request.getParameter("recordno") %>">
							</div>
						</div>
                        <div class="form-group field-task-subject required">
							...
							<div class="col-sm-8">
								<input type="text" id="car_no" class="form-control"
									name="topic" maxlength="40" placeholder="<%=request.getParameter("carno") %>">
							</div>
						</div>
						...
						<div class="form-group field-task-content">
							<label class="control-label col-sm-2" for="task-content">备注</label>
							<div class="col-sm-8">
								<textarea id="Note" class="form-control"
									name="description" rows="6" placeholder="详细情况说明"></textarea>
							</div>
						</div>
