...
<body class="navbar-top">
			...
			<div class="widget-container fluid-height clearfix mwi1200">
				...
				<div class="widget-content padded clearfix">
				 	<form id="create_reord" class="form-horizontal"
						...
						<div class="form-group field-task-subject required">
							<label class="control-label col-sm-2" for="task-subject">驾驶人身份证号</label>
							<div class="col-sm-8">
								<input type="text" id="driveidentity" class="form-control"
									name="topic" maxlength="40" placeholder="请输入正确的驾驶员身份证号">
							</div>
						</div>
						<div class="form-group field-task-subject required">
	...
	<script  type="text/javascript">
		function commitCheck() {
            ...
            var driveridentity=$("#driveidentity").val();
