...
<script>
function createcarpai()
{   var carno=$("#carno").val();
     var caremissions=$("#caremissions").val();
	 var grantunit=$("#grantunit").val();
	 var useyearlimits=$("#useyearlimits").val();
	 var carproductdate=$("#carproductdate").val();
	 var carbrandtype=$("#carbrandtype").val();
	 var grantdate=$("#grantdate").val();
	 var carengineno=$("#carengineno").val();
     var caremissions=$("#caremissions").val();
	 var cardriverlicenseno=$("#cardriverlicenseno").val();
	 var lastyearcheckdate=$("#lastyearcheckdate").val();
	 var nextyearcheckdate=$("#nextyearcheckdate").val();
     var usetype=$("#usetype").val();
	 var responseridentity=$("#responseridentity").val();
     var responserphone=$("#responserphone").val();
	 var ownername=$("#ownername").val(); 
	 var ownersex=$("#ownersex").val();
	  var owneridentity=$("#owneridentity").val();
     var owneraddress=$("#owneraddress").val();
	 var carpaimemo=$("#carpaimemo").val();
	 var cartons=$("#cartons").val();
	 var responsername=$("#responsername").val(); 
	 var data={};
     data.carpaino=carno;
	 data.caremissions=caremissions;
     data.carpaigrant=grantunit; 
     data.carpaiuselimit=useyearlimits;  
     data.carbrandtype=carbrandtype;   
     data.carengineno=carengineno;//
	 data.driverno=cardriverlicenseno;   
	 data.carproductdate=carproductdate;  
	 data.carlastyearcheck=lastyearcheckdate;
	 data.carnextyearcheck=nextyearcheckdate;  
	 data.carusetype=usetype; 
	 data.grantdate=grantdate; // 
     data.carpairesponseridentity=responseridentity;
	 data.carpairesponserphone=responserphone;
	 data.carpaiownername=ownername; 
	 data.carpaiownersex=ownersex;
	 data.carpaiowneridentity=owneridentity;
	 data.carpaiowneraddress=owneraddress;
	 data.carpaimemo=carpaimemo;
	 data.cartons=cartons;
	 data.carpaiownername=responsername;  
	 data.carpairesponsername=responsername;
	$.ajax({
		  url:'car/addcarpai',
		  type:'post',
		  data:data,
                            ...
                            <div class="span12">
                                <table class="table table-bordered" id="no-input-border" width="95%" border="0"
                                    ...
                                    <tr>
                                        ...
                                        <th style="border: none;float: right;"> </th>
                                    </tr>
