                     ...
                     <div class="form-group field-contacts-selectcustomer required">
                        ...
                        <div class="col-sm-8">
							  <input type="text" id="business-selectcustomer"
										...
										dialog-callback="actionCallBacks" dialog-title="选择客户" value="百度"
										dialog-url="/customer/dialog-list.html"
										onclick="selectCustomer()"> <input type="hidden" id="customerId" value="1"/>
                        </div>
                        ...
                        <div class="col-sm-8">
                            ...
                            <div id="contacts-sex">
                                <label class="label-radio inline">
                                    <input type="radio" name="Contacts[sex]" value="1" id="nanId" checked> <span
...
<script type="text/javascript">
 function selectCustomer(){
	...
	var sexid=$("#sexid").val();
	 ...
	 var list = document.getElementsByName("Contacts[sex]");
	 for ( var i = 0; i < list.length; i++) {
		if (list[i].value==sexid) {
			list[i].checked=true;
		}
	}
...
// 	}
	...
	$.ajax({
		   type: 'post',
           url: 'LinkManServlet?method=updateLinkMan',
           data: data,
           cache: false,
           sync: true,
